--@PREFIX@verificationMultiSigBasicSymbolicExecution
...
--@BEGININLINE@multisigsymbolic
        ⟦ multiSigScript-2-4-b pbk₁ pbk₂ pbk₃ pbk₄ ⟧stb time₁ msg₁ stack₁
--@END
{- evaluated we get
...
test2 : Maybe Stack
test2 =
--@BEGININLINE@resultmultisig
      executeMultiSig3 msg₁ (pbk₁ ∷ pbk₂ ∷ pbk₃ ∷ pbk₄ ∷ []) 2 stack₁ []
--@END

-- now we try out stack₁ = []

multisigScript-2-4-symbolic-empty = ⟦ multiSigScript-2-4-b pbk₁ pbk₂ pbk₃ pbk₄ ⟧stb time₁ msg₁ []

{-
result nothing
-}

multisigScript-2-4-symbolic-1stackelement = ⟦ multiSigScript-2-4-b pbk₁ pbk₂ pbk₃ pbk₄ ⟧stb time₁ msg₁ (sig₂ ∷ [])

{-
result nothing
-}

multisigScript-2-4-symbolic-2stackelement = ⟦ multiSigScript-2-4-b pbk₁ pbk₂ pbk₃ pbk₄ ⟧stb time₁ msg₁ (sig₂ ∷ sig₁ ∷ [])
